...
/**
 */
public class InterProtocolComcenterInitializer extends ChannelInitializer<SocketChannel> {
    @Override
    public void initChannel(SocketChannel ch) throws Exception {
        ...
        pipeline.addLast(new InterProtocolComcenterHandler()); //new LoggingHandler(LogLevel.INFO), 
    }
}
