/*
********************************************************************************************
Discription:  大平台内部协议，超时事件，修改于netty的ReadTimeoutHandler
...
public class InterProtocolTimeoutHandler extends ChannelInboundHandlerAdapter {
     ...
     */
    public InterProtocolTimeoutHandler(int timeoutSeconds) {
     ...
     */
    public InterProtocolTimeoutHandler(long timeout, TimeUnit unit) {
        if (unit == null) {
