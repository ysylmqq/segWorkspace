...
public class ZooKeeperTestClient implements Watcher {
  protected String hostPort = "90.0.12.201:2181,90.0.12.202:2181,90.0.12.203:2181";
  
 //protected String hostPort = "master:2181,slave1:2181,slave2:2181";
  ...
  /**
   * 创建持久根节点 /test_dir  /test_dir/00993994939493
   * dirOnZK = "/test_dir";
   * testDirOnZK = dirOnZK + "/" + System.currentTimeMillis();
   * @throws IOException
   * @throws InterruptedException
   */
