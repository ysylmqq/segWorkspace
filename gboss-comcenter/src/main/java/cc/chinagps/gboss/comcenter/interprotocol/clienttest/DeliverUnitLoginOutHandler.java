...
public class DeliverUnitLoginOutHandler extends ClientBaseHandler {

	public String callLetter = "";	//车辆呼号
	public int gatewayid = 0;  		//网关编号
	public int inorout = 1;         //0:退录，1:登录

	public DeliverUnitLoginOutHandler(ComCenterBaseMessage basemsg, CenterClientHandler handler) {
