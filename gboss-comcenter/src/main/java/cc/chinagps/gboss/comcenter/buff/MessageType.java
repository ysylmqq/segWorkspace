...
public class MessageType {
	...
	public static final short GetCommandHistory = 1053;      	//查询历史指令
	public static final short GetCommandHistory_ACK = 8053;  	//查询历史指令回应
	...
	public static final short DeliverUnitVersion = 2011;     	//终端升级成功上报版本号
	public static final short DeliverFaultLight = 2012;     	//上传故障灯状态
	public static final short DeliverECUConfig = 2013;			//上传ECU配置
    ...
    public static final short AskSyncAlarmList = 4003;         	//Slaver请求同步警情列表
    public static final short AskSyncAlarmList_ACK = 12003;     //Master应答同步警情列表
}
