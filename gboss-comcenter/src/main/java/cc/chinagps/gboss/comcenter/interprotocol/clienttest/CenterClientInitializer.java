...
public class CenterClientInitializer extends ChannelInitializer<SocketChannel> {
	...
	protected void initChannel(SocketChannel ch) throws Exception {
        ...
        //内部协议客户端，自定义处理
        CenterClientHandler.clienthandler = new CenterClientHandler();
        
        //下面四项要从配置文件读
        CenterClientHandler.clienthandler.setNodeId("0010");   		//自己的节点ID
        CenterClientHandler.clienthandler.setUserName("seggps");	//登录名
        CenterClientHandler.clienthandler.setPassword("123456");	//密码
        CenterClientHandler.clienthandler.setServerNodeId("0001");	//服务器端节点ID
        
        pipeline.addLast(CenterClientHandler.clienthandler);
	}
}
