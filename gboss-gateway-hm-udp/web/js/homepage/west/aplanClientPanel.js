var AplanClientPanel = function(){
	//var panel = this;

	var store = new Ext.data.Store({
		proxy: new Ext.data.HttpProxy({
			url: 'loadInfo?type=aplan'
		}),
	...
	var clientGrid = new Ext.grid.GridPanel({
		...
		listeners: {
			rowcontextmenu: function(grid, row, e){
				...
				common_current_type = "kickoffaplan";
				common_menu.showAt(e.getXY());
			}
		}
	});
	
	AplanClientPanel.superclass.constructor.call(this,{
		title: " A计划 ",
		border: false,
		layout: 'border',
		items: [{
...
Ext.extend(AplanClientPanel, Ext.Panel);