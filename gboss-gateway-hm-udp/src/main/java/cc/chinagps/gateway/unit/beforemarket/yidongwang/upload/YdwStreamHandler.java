...
public class YdwStreamHandler implements InputStreamController, InputPackageHandler{
	...
	private YdwUploadCmdHandlers uploadHandlers = UnitCommon.ydwUploadHandlers;
	
	public YdwStreamHandler(UnitServer server, UnitSocketSession session){
		this.server = server;
