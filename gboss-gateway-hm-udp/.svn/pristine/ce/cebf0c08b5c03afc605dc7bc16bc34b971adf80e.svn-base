...
public class KaiyiStreamHandler implements InputStreamController, InputPackageHandler{
	...
	KaiyiUploadCmdHandlers uploadHandlers = UnitCommon.kaiyiUploadHandlers;
	
	public KaiyiStreamHandler(UnitServer server, UnitSocketSession session){
		this.server = server;
