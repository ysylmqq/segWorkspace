...
public class KaiyiOBDInfo {
	 ...
	 * 解码
	 */
	public static KaiyiOBDInfo parse(byte[] data, int offset){
		//前2字节为长度		
		int position = offset;
		...
		KaiyiOBDInfo obdInfo = new KaiyiOBDInfo();
	...
	public static void main(String[] args) {
		KaiyiOBDInfo obd = new KaiyiOBDInfo();
		obd.setHourOil(10);
