...
public class LeopaardECUConfig {
	...
	public static LeopaardECUConfig parse(byte[] data, int offset){
		int position = offset;
		...
		byte reserve = dataLength >= 4? data[position + 4]: 0;
		...
		LeopaardECUConfig ecuConfig = new LeopaardECUConfig();
