...
public class KaiyiGPSInfo {
	...
	public static KaiyiGPSInfo parse(byte[] data, int offset) throws Exception{
		KaiyiGPSInfo gpsInfo = new KaiyiGPSInfo();
		int position = offset;
	...
	public static void main(String[] args) throws Exception {
		...
		KaiyiGPSInfo pgps1 = KaiyiGPSInfo.parse(data, 0);
		...
		KaiyiGPSInfo pgps2 = KaiyiGPSInfo.parse(hex_bs, 0);
