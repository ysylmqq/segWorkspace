...
public class AlipayCore {
    ...
    public static String createLinkStringNoSort(Map<String, String> params) {
    	...
    	sortList.add("service=" + params.get("service"));
    	sortList.add("v=" + params.get("v"));
    	sortList.add("sec_id=" + params.get("sec_id"));
    	sortList.add("notify_data=" + params.get("notify_data"));
