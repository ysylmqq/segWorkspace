...
public class Utils {
	private static String OS = System.getProperty("os.name").toLowerCase(); //获取System.getProperty("os.name")对应的操作系统 
    ...
    public static String list2String(List<String> list){
	 ...
	 public static String list2String2(List<String> stringList){
         if (stringList==null) {
             return null;
         }
