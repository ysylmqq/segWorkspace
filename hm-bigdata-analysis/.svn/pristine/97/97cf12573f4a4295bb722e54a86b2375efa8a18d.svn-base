...
public class AlarmFilterHbase {
	...
	public void scanAlarmTable() throws IOException{
		...
		for (int i = 0; i < list.size(); i++) {
			...
			if (StringUtils.isNotBlank(callLetter)) {
				...
				/*2017-09-10 23:59:59 1505059199000
				2017-09-12 23:59:59 1505231999000*/
				/*byte[] startKey = HBaseKeyUtil.getKey(callLetter, 1505059199000L);	
				byte[] endKey = HBaseKeyUtil.getKey(callLetter, 1505231999000L); */
	...
	public static void main(String[] args) {
		Date date =	new Date(117, 8, 10, 23, 59, 59);
		SimpleDateFormat datetimeFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		String str = datetimeFormat.format(date); 
		
		Date date1 = new Date(117, 8, 12, 23, 59, 59);
