$(function(){
	...
	var defaults = {
		...
		colModel : [{display : '4S店名称', name : 'fc_name', width : '180', sortable : false }
			, {display : '入网数量', name : 'join_count', width : '180', sortable : false }
			, {display : '离网数量', name : 'off_count', width : '180', sortable : false }
			, {display : '在网总数', name : 'in_count', width : '100', sortable : false}
