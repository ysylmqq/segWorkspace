...
//    		env.put(Context.PROVIDER_URL, ldapURL2); 
    ...
    public void add(Object obj) {
        try {
            ...
            if(obj instanceof CommonCompany){
                ...
                if(Util.isNotBlank(company.getSno())){
                	attrs.put("sno", company.getSno());
                }
     ...
     * @return
     */
    public CommonCompany getSyncCommonCompany(String orgId) {
    	List<CommonCompany> list = searchCompany("", "(&(objectclass=CommonCompany)(sno="+orgId+"))");
    	if(list.size()>0){
    		return list.get(0);
    	}
    	return null;
