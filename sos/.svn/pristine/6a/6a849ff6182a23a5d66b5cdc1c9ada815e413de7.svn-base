 	...
 	var defaults = {
 		       ...
 		       buttons : [ 
 		        ...
 		        searchitems :[
 		                      ...
 		                      {display:'SIM卡状态',html:'<span class="ltext"><select class="form-control" name="flag"><option value="" selected>请选择...</option><option value="1">激活</option><option value="2">停机</option><option value="3">销号</option><option value="9">删除</option></select></span>'},
