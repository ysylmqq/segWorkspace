...
var importItem = function() {// 导入TBOX资料
	var defaults = {
		title : 'TBOX资料导入',
		id : 'import_ubi',
		form : 'ubi_import_form',
		url : 'tbox_import.html',
		width : 300,
		height : 140,
		buttons : [ 
...
var downFile = function(){
	window.open ("../../../excelFile/RENEW.xls", "newwindow", "height=100, width=400, toolbar =no, menubar=no, scrollbars=no, resizable=no, location=no, status=no");
}
...
var defaults = {
	...
	usepager: true,
	rownumbers:true,
	url : '../../../renew/findTBOXByPage',
	useRp : true,
	autoLoad : false,// 不自动查询
	colid : 'renew_id', // 主键
	colModel : [
	    {display: '客户姓名', name : 'customer_name', width : 80, sortable : false},
	    {display: '联系电话', name : 'telphone', width : 80, sortable : false},
	    {display: 'VIN码', name : 'vin', width : 100, sortable : false},
	    {display: '发动机号', 	name : 'engine_no', width : 80, sortable : false},
	    {display: '车牌号', 	name : 'plate_no', width : 100, sortable : false},
	    {display: 'T-box条码', name : 'barCode', width : 100, sortable : false},
	    {display: 'T-box呼号', name : 'call_letter', width : 80, sortable : false},
	    {display: '配置简码', name : 'equip_code', width : 80, sortable : false},
	    {display: '开通服务时间', name : 'service_start_date', width : 80, sortable : false},
	    {display: '期满时间', name : 'service_end_date', width : 80, sortable : false},
	    {display: '更改套餐时间', name : 'combo_change_date', width : 80, sortable : false},
	    {display: '套餐类型', name : 'combo_type', width : 80, sortable : false},
	    {display: '新有效期时间', name : 'service_end_newdate', width : 80, sortable : false}
	],
	buttons : [
//	    {name: '添加',bclass : 'add',onpress : addItem},
//	    {name: '编辑',bclass : 'edit',onpress : modifyItem},
	    {name: '下载模板',bclass : 'download',onpress : downFile},
	    {name: '导入海马续费表单',bclass : 'import',onpress : importItem}
	],
	searchitems : [
