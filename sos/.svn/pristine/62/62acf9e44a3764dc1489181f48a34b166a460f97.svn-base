...
public class SystemConst {
	...
	static{
		reasonMap.put("1", "车子将/已转卖/报废");
		reasonMap.put("2", "产品质量问题");
		reasonMap.put("3", "4S店服务品质问题");
		reasonMap.put("4", "服务中心服务质量问题");
		reasonMap.put("5", "营业处服务质量问题");
		reasonMap.put("6", "使用价值不大");
		reasonMap.put("7", "个人原因");
		reasonMap.put("8", "其他原因");
		reasonMap.put("9", "暂时停止");
	}
	...
	//海马呼号集合
	public static  Map<String, String> call_letterMap = new HashMap<String, String>();
		static{
			call_letterMap.put("call_letter", "");
		}
	/*//sim卡集合
	public static  Hashtable<String, Preload> SIM_MAP = new Hashtable<String, Preload>();
	static{
	}
	public static  Hashtable<String, Preload> IMEI_MAP = new Hashtable<String, Preload>();
	static{
	}
	public static  Hashtable<String, Preload> BARCODE_MAP = new Hashtable<String, Preload>();
	static{
	}*/
