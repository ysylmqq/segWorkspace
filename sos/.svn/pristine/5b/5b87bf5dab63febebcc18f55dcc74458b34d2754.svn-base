...
public interface VehicleDao extends BaseDao {
	...
	public Integer updateVehicleStataus(Map<String, Object> param, int status)throws SystemException;

	public Integer updateVehiclePwd(Long vehicleId, String servicePwd, String privatePwd, String updateType)throws SystemException;

	public boolean isVehicleepeat(Long vehicleId, String plateNo, String vin, String engineNo)throws SystemException;
