...
@Entity
@Table(name = "t_fee_hm_renew")
public class Renew extends BaseEntity{
	
	private static final long serialVersionUID = 1L;
	
	private Integer renew_id;//'序号',
	...
	public Integer getRenew_id() {
		return renew_id;
	}
	public void setRenew_id(Integer renew_id) {
