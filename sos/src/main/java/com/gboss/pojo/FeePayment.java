 ...
 * @Description:TODO
 * @author:xiaoke
 * @date:2014-6-17 下午4:07:59
 */
@Entity
@Table(name = "t_fee_payment")
...
*/	private Integer s_months;//'服务时长(月), 如采用余额方式, 无效',
	...
	private Integer flag;//交易标记, 0=成功, 1=失败, 2=作废
	...
	*/
	...
	@Column(name = "pay_time",nullable=false,updatable=true,insertable=true)
