...
/**
 * @Package:com.gboss.pojo.web
 * @ClassName:LargeCustNetworkEntry
 * @Description:
 * @author:xiaoke
 * @date:2014-4-18 下午5:35:09
 */
public class LargeCustNetworkEntry {
	
	private Long cust_id;//客户id
	private String customer_name;//客户名称
	private Long companyno;//ldap中companyno
	...
	private Integer pay_model;//付费方式
	...
	private String sim_start_time;// SIM卡截止时间
	...
	private Servicetime servicetime;//服务费截止时间
	...
	public String getSince_no() {
		return since_no;
	}

	public void setSince_no(String since_no) {
		this.since_no = since_no;
	}
