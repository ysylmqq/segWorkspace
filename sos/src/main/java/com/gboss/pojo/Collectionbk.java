...
@Entity
@Table(name = "t_ba_collection_bk")
public class Collectionbk extends BaseEntity {

	private static final long serialVersionUID = 1L;

	private Long bkfc_id;//历史记录ID
	...
	private Integer ac_type;//'账号类型, 系统值3120, 0=借记卡, 1=存折, 2=信用卡',
	...
	private Integer fee_cycle;//'收费周期(月)',
	private Integer is_delivery;//'发票是否投递, 系统值3110, 0=不投递, 1=平邮, 2=挂号信, 3=电子账单',
