...
public class Collection extends BaseEntity {
	...
	private String tax_payer_seq;//'纳税人识别号',
	...
	@Column(name = "tax_payer_seq")
	public String getTax_payer_seq() {
		return tax_payer_seq;
	}
	public void setTax_payer_seq(String tax_payer_seq) {
		this.tax_payer_seq = tax_payer_seq;
	}
