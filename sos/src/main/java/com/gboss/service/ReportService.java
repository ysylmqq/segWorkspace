...
public interface ReportService extends BaseService {
	...
	Page<Map<String, Object>> findPrivateWeekPage(Map<String, Object> params, Integer pn, Integer pageSize)throws SystemException;
	
	List<Map<String, Object>> listPrivateWeek(Map<String, Object> params)throws SystemException;
}
