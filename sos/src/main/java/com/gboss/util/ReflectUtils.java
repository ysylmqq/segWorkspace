...
public class ReflectUtils {
	...
	public static List buildListForImport(List<String[]> dataList, Map<String, String> cols, Map<String, Object> defVals,
		Map<String, Map<String, String>> transfMap,Object obj,String FMT){
				...
				for(Field field : fields){
					...
					if(StringUtils.isNotBlank(colVal)){	//只有在值存在的条件下才做反射处理
						...
						if(StringUtils.equals(type, "java.util.Date")){
							...
							me.invoke(obj2, new Object[]{DateUtil.parse(colVal.replace("/", "-"), FMT)});							
							continue;
						}
					}
				}
	...
	public static List buildListForImport(List<String[]> dataList, Map<String, String> cols, Map<String, Object> defVals, 
			...
			Object obj){
		return ReflectUtils.buildListForImport(dataList, cols, defVals, transfMap, obj, DateUtil.YMD_DASH_IMPORT);
	}
