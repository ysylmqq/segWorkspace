...
(function(global) {
    ...
    function loadByteBuffer(Long) {
        ...
        ByteBuffer.fromBase64 = function(str, littleEndian, noAssert) {
            ...
            //var h2, h3, h4;     // has input?
            var bb = new ByteBuffer(len/4*3-suffix, littleEndian, noAssert);
            for (i=0, j=0; i<len; ) {
                b1 =                  B64.indexOf(str.charAt(i++));
                b2 = (i < len) ? B64.indexOf(str.charAt(i++)) : 0;
                b3 = (i < len) ? B64.indexOf(str.charAt(i++)) : 0;
                b4 = (i < len) ? B64.indexOf(str.charAt(i++)) : 0;
                if (!noAssert) {
