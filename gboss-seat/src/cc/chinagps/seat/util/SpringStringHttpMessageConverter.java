...
public class SpringStringHttpMessageConverter extends
	...
	public SpringStringHttpMessageConverter() {
		this(DEFAULT_CHARSET);
	}

	public SpringStringHttpMessageConverter(Charset defaultCharset) {
		...
		availableCharsets.add(Charset.forName("UTF-8"));
	}
