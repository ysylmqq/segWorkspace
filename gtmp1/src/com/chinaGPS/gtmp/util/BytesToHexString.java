...
/**
 * @Package:com.chinaGPS.batchprocess.util
 * @ClassName:BytesToHexString
...
public class BytesToHexString {
  ...
  //flaot小数点后四舍五入保留两位
	public static float floatTwo(Float fl)
	{
		float ft;
    	int scale= 2; //设置位数
    ...
    public static void main(String args[]) {
    	...
    	String a  = "3038333234353431377e3038333234353431377B200005420000677D";
    	a = a.substring(a.lastIndexOf("7B"));
    	a = a.substring(4, 10);
