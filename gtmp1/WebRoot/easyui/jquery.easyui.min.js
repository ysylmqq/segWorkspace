...
//add by zfy 2013-5-31日 用于运营管理左边的树 --begin
if(opts.fit2==true){
var p=cc.parent();
p.addClass("panel-noscroll");
if(p[0].tagName=="BODY"){
...
var offsetInterval=cc.offset().top-p.offset().top;
opts.width=p.width();
opts.height=p.height()-offsetInterval;
}
//add by zfy 2013-5-31日 用于运营管理左边的树 --end
...
$.fn.validatebox.defaults={required:false,validType:null,missingMessage:"必填项.",invalidMessage:null,rules:{email:{validator:function(_39c){
...
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{frozenColumns:undefined,columns:undefined,fitColumns:false,autoRowHeight:true,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,loadMsg:"Processing, please wait ...",rownumbers:false,singleSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:false,pagePosition:"bottom",pageNumber:1,pageSize:20,pageList:[20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowStyler:function(_5e5,_5e6){
