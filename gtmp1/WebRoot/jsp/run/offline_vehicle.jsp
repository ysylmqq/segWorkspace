...
<!--在线、不在线窗口-->
<!-- 在线、离线--begin -->
	<div closed="true" id="dlg_offline_run" class="easyui-dialog" title="离线"
		style="width: 800px; height: 500px; overflow: hidden" buttons="#dlg_offline_run_btns" data-options="maximizable:true,onResize:dlgOnlineResize">
		<table id="offline_run_datagrid" 
			toolbar="#offline_run_toobar"
	...
	<div id="offline_run_toobar"  
		style="height: auto; display: none">
			整机编号： <input id="vehicleDef_offline_run" type="text" 
				style="width: 120px;" />
				<a href="#" class="easyui-linkbutton"
				iconCls="icon-search" onclick="queryOffline()">查询</a> 
	</div>
	
	<div id="dlg_offline_run_btns">  
	    <a href="#" class="easyui-linkbutton" iconCls="icon-cancel" onclick="javascript:$('#dlg_offline_run').dialog('close')">关闭</a>  
	   </div> 
	<!-- 在线、不在线--end -->