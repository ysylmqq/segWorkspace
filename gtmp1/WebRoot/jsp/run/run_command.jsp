...
<div id="dlg_lock" class="easyui-dialog" title="锁车管理"
	data-options="iconCls:'icon-save',modal: true"
	style="padding: 5px; width: 360px; height: 400px;" closed="true"
	buttons="#btns_lock">
			...
			<tr>
				<td >
					<fieldset>
						...
						<tr>
						     <td><input type="checkbox" id="timing_lock" name="timing_lock"
							value="1"/>
						预约锁车</td>
						     
						</tr>
						<tr>
						     <td class="radio_b"> <input type="radio"  name="radio_lock"
							value="5A0000"/>
						使能防拆保护</td>
						     <td class="radio_b"><input type="radio" name="radio_lock" value="A50000" />
						禁止防拆保护</td>
						</tr>
						<tr>
						     <td><input type="radio" name="radio_lock" value="005BC5" />
						使能A级锁车</td>
						     <td class="radio_b"><input type="radio" name="radio_lock" value="00B500" />
						解除A级锁</td>
						</tr>
						<tr>
						     <td ><input type="radio" name="radio_lock" value="00B55C" checked="checked"/>
						使能B级锁车</td>
						     <td class="radio_b"><input type="radio" name="radio_lock" value="0000C5" />
						解除B级锁</td>
						</tr>
						<tr>
						     <td class="radio_b" hidden = "hidden">锁车时间:
						     </td>
						     <td class="radio_b" hidden = "hidden"><input id="lock_time" name="lock_time" class="Wdate"
			...
			<tr>
				<td align="left" >
					...
					<option value="02">升级图形</option> 
							...
							<td>程序版本号:</td><td><input type="text" id="txt_pVersion" value="2135">
						</td>
...
<!--工况信息导入--begin-->
<div id="dlg_workinfoinsert" class="easyui-dialog" title="工况信息导入"
	data-options="iconCls:'icon-save',modal: true"
	style="padding: 5px; width: 400px; height: 100px;" closed="true"
	buttons="#btns_workinfoinsert">
	<form id="frm_workinfoinsert" name="frm_workinfoinsert" method="POST"
		metdod="post" tdeme="simple">
		<table cellpadding="4" cellspacing="0"
			style="font-size: 12px; width: 100%;">
			<tr>
	...
	<div id="btns_workinfoinsert">
	    <a href="#" class="easyui-linkbutton" iconCls="icon-ok"
			onclick="sbWorkInfo()">导入</a>
		<a href="#" class="easyui-linkbutton" iconCls="icon-cancel"
			onclick="javascript:$('#dlg_workinfoinsert').dialog('close')">关闭</a>
	</div>
</div>
<!--工况信息导入--end-->