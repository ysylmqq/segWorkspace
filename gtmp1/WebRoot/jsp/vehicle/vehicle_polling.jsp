...
<script type="text/javascript" src="${basePath}js/vehicle_polling.js"></script> 
<div id='loading_polling'
...
<div class="easyui-layout" data-options="fit:true"
	...
	<div id="polling_west_panel"
		data-options="region:'west',split:true,title:'监控面板',doSize:true"
		style="width: 300px;">
		<!-- 整机编号/SIM卡号 -->
		<input type="text" id="polling_tree_text"
		...
		<a href="javascript:void(0)" class="easyui-linkbutton"
			iconCls="icon-search" onclick="querypollingTree()">查询</a>
		<a href="javascript:void(0)" onclick="openQueryDialog()">更多条件</a>

		<div id="tabs_tree" class="easyui-tabs" data-options="fit2:true">
			<div title="机械列表">
				<ul id="polling_tree"
					data-options="url:'${basePath}vehicle/vehiclePolling_getVehicle4Tree.action',onlyLeafCheck:true"></ul>
			</div>
			<div title="监控列表">
				<table class="easyui-datagrid"
					data-options="url:'${basePath}vehicle/vehiclePolling_getWatchVehicle.action',
                     fitColumns:true,rownumbers:true,onRowContextMenu:monitorRightClick"
					id="grid_polling_monitor">
					<thead>
						<tr>
							<th
	...
	<div data-options="region:'center',doSize:true">
		<div class="easyui-layout" data-options="fit:true"
			style="width: 100%; height: 100%;">
			<div data-options="region:'center',tools:'#map_tb'" id="polling_map_div"
				title="我的地图" style="overflow: hidden">
				<iframe id="ifm_map_polling" name="ifm_map_polling"
					src="${basePath}jsp/vehicle/polling_map.jsp"
			...
			<div data-options="region:'south',split:true,onResize:southResize" style="height: 160px;">
				<div id="tabs_south" class="easyui-tabs" data-options="fit:true">
					<!-- gps信息刷新表格--begin -->
	...
	<div id="map_tb">
		<a href="#" class="icon-map_area" onclick="javascript:ifm_map_polling.window.operateMap(8)" title="拉框搜索"></a>
		<a href="#" class="icon-move"
			onclick="javascript:ifm_map_polling.window.operateMap(3)" title="恢复默认工具"></a>
		<a href="#" id="afullscrenn" class="icon-fullscreen"
			onclick="javascript:fullscreen();" title="全屏"></a>
		<a href="#" class="icon-bigger"
			onclick="javascript:ifm_map_polling.window.operateMap(1)" title="放大"></a>
		<a href="#" class="icon-smaller"
			onclick="javascript:ifm_map_polling.window.operateMap(2)" title="缩小"></a>

		<a href="#" class="icon-ceju"
			onclick="javascript:ifm_map_polling.window.operateMap(4)" title="测距"></a>
		<a href="#" class="icon-center"
			onclick="javascript:ifm_map_polling.window.operateMap(5)" title="居中"></a>
		<a href="#" class="icon-clear"
			onclick="javascript:ifm_map_polling.window.operateMap(7)" title="清除机械信息"></a>
		<input type="checkbox" name='isShowPlateNumber' id="isShowPlateNumber" checked="checked" onclick="javascript:ifm_map_polling.window.isShowPlateNumber(this)"><label style="font-size:12px;color:black;font-weight:normal">显示整机编号</label>
	</div>

	<div id="menu_polling_right" class="easyui-menu" style="width: 150px;">
   ...
   <!-- 开发时写死的菜单，正式部署时，可删除注释的代码
	...
	<!--指令相关窗口-->
	<jsp:include page="polling_command.jsp"></jsp:include>

	<!--密码确认窗口-->
	<jsp:include page="../run/input_pwd.jsp"></jsp:include>
	
	<!-- 更多条件窗口 --begin-->
	<div id="dlg_more_condition" class="easyui-dialog" title="更多查询条件"
		data-options="iconCls:'icon-save',modal:true"
		style="padding: 5px; width: 600px; height: 200px;" closed="true"
		buttons="#btns_more_condition">
		<form id="frm_polling_query" name="frm_polling_query" method="POST"
			metdod="post" tdeme="simple"
			action="${basePath}polling/polling_getVehilces.action">
...
<script type="text/javascript">
    ...
    function show(){
        $("#loading_polling").fadeOut("fast", function(){
            $(this).remove();
