<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<script type="text/javascript" src="${basePath}js/avg_workhours_statistic.js"></script>
...
<div  class="easyui-layout" data-options="fit:true,border:false" style="width:100%;height:100%;">
   <div data-options="region:'center',border:false,onResize:avg_workhoursQueryResize"  style="overflow:hidden;">
    <!-- 表格 begin -->
    <table id="avg_workhours_statistic_datagrid" toolbar="#toolbar" class="easyui-datagrid"
			style="width: auto; height: auto;" rownumbers="true"
			data-options="
            fitColumns:true,singleSelect:true,rownumbers:true,title:'平均工作时间统计',onClickCell:malfunnStatisCellClick">
             <thead>  
            <tr>
            </tr>  
        </thead>
		    ...
		    <table style=" font-size: 12px;">
		      ...
		      <td align="right">
		       ...
		       <tr>
				...
				<td>
				<input id="start_time" type="text" class="Wdate" onFocus="WdatePicker({dateFmt:'yyyy-MM'})">
				</td>
				<td>
					结束时间: </td>
				<td>
				<input id="end_time" type="text" class="Wdate" onFocus="WdatePicker({dateFmt:'yyyy-MM'})">
					</td>
			    <td colspan="2">
			   <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search" onclick="statistic_avg_workhours()">查询</a>
	...
	<!-- 平均工作时间统计--begin -->	
		<div  closed="true" class="easyui-dialog"  id="dlg_avg_workhours_detail" 
		style="width: 630px; height: 300px; overflow: hidden" data-options="title:'平均工作时间统计详细'"
		 buttons="#dlg_avg_workhours_detail_btns">
		<table id="avg_workhours_detail_datagrid" class="easyui-datagrid"
		...
		<div id="dlg_avg_workhours_detail_btns">  
	    <a href="#" class="easyui-linkbutton" iconCls="icon-cancel" onclick="javascript:$('#dlg_avg_workhours_detail').dialog('close')">关闭</a>  
	</div> 
	<!--平均工作时间统计--end -->
