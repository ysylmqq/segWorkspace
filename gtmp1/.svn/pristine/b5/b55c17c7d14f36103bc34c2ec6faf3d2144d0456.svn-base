...
<script type="text/javascript" src="${basePath}js/project_info.js"></script>
...
<div  class="easyui-layout" data-options="fit:true,border:false" style="width:100%;height:100%;">
   <div data-options="region:'center',border:false,onResize:askResize"  style="overflow:hidden;">
	...
	<tr><td width="50px">联系人：</td><td> <input type="text" id="contact" /></td>
	<td width="70px">联系方式：</td><td> <input type="text" id="phoneNumber" /></td>
	...
	<td><img id="testButtonTrue1" onclick="askChecked()" style="cursor: pointer;" src="images/user/2_s.png">
	<img id="testButtonFalse1" onclick="askChecked()" style="cursor: pointer;display:none" src="images/user/2_x.png"></td></tr>
	</table>
	...
	<table id="projectInfo_datagrid"  toolbar="#toolbar" class="easyui-datagrid"
			...
			data-options="nowrap:false,url:'${basePath}userInfo/projectInfo_search.action',fitColumns:true,singleSelect:true,rownumbers:true,pagination:true,title:'工程信息发布'">
             <thead>  
            <tr >  
            	<th data-options="field:'id',width:0,hidden:true"></th>
                <th data-options="field:'title',width:90,align:'left',formatter:formatterText">工程信息标题</th>
                <th data-options="field:'createName',width:90,align:'left'">发布人</th>
                <th data-options="field:'createTime',width:90,align:'left'">发布时间</th>
            </tr>  
        </thead>
	 </table>
	 </div>
	...
	<!-- 问题回答弹出页面--begin -->	
		...
		<table class="jcbLegend"  style="width: auto; height: auto;" rownumbers="true" pagination="true" >
			...
			<tr>
			<td align="right">
			<span style="font-size: 12px;font-weight:bold;color: blue;border: 1px solid blue">联系人：</span>&nbsp;<span style="font-size: 12px;font-weight:bold;color: blue;" id="Label3"></span>&nbsp;&nbsp;<span style="font-size: 12px;font-weight:bold;color: blue;border: 1px solid blue">联系方式：</span>&nbsp;<span style="font-size: 12px;font-weight:bold;color: blue;" id="Label4"></span>
