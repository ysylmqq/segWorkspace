...
<script type="text/javascript" src="${basePath}js/unwork_query.js"></script>
...
<div class="easyui-layout" data-options="fit:true,border:false" style="width: 100%; height: 100%;">
	<div data-options="region:'center',border:false,onResize:unWorkResize" style="overflow: hidden;">
		<!-- 表格 begin -->
		<table id="unwork_query_datagrid" toolbar="#toolbar" class="easyui-datagrid" style="width: auto; height: auto;"
			data-options="fitColumns:true,singleSelect:true,rownumbers:true,pagination:true,title:'未工作机械查询'">
			<thead>
				<tr>
					...
					<th data-options="field:'lastWorkDate',width:130,align:'center'">最后工作时间</th>
			...
			<table style="font-size: 12px;">
				<tr>
                 ...
                 " />
					...
					<td>
						<select id="days_search" class="easyui-combobox"
							name="days_search" style="width: 150px;">
				...
				<tr>
					...
					<td colspan="4">
						<a href="javascript:void(0)" class="easyui-linkbutton"
							iconCls="icon-search" onclick="queryUnwork()">查询</a>
...
<script type="text/javascript">
	...
	$.parser.onComplete = function(obj) {
		$('#unwork_query_datagrid').datagrid('columnMoving');
		if (delayTime)
