...
<script type="text/javascript" src="${basePath}js/owner.js"></script>
...
<div class="easyui-layout" data-options="fit:true" style="width: 100%; height: 100%;">
	<div id="run_west_panel"
		...
		<div id="tabs_tree" class="easyui-tabs" data-options="fit2:true">
			<div title="机械列表">
				<ul id="run_tree"
					data-options="url:'${basePath}run/owner_getDealerAreasList.action',onlyLeafCheck:false"></ul>
			</div>
			<%-- <div title="监控列表">
				<table class="easyui-datagrid"
					data-options="url:'${basePath}run/owner_getWatchVehicle.action',
	...
	<div data-options="region:'center',doSize:true">
		<div class="easyui-layout" data-options="fit:true"
            ...
            fitColumns:false,singleSelect:false,rownumbers:true,onRowContextMenu:gpsRightClick,onDblClickRow:gpsDblClick"
							...
							<thead>
								<tr>
									...
									<th data-options="field:'gpsTime',width:150,align:'center',formatter:vehicleStateFormat">
										GPS定位时间
									</th>
									<th
									...
									<th
										data-options="field:'nowTime',width:200,align:'center',formatter:vehicleStateFormat">
										上报时间
									</th>
								</tr>
							</thead>
            ...
            singleSelect:false,rownumbers:true,onRowContextMenu:workInfoRightClick"
               ...
               <th data-options="field:'stamp',width:150,align:'center',sortable:true">最后工况时间</th>
	...
	<div id="map_tb">
		<!-- <input type="button" id="online_run_btn" value="在线(0)" class="map_toolbar" onclick="openOnlineWin(0)"/>
		<input type="button" id="offline_run_btn"value="离线(0)" class="map_toolbar" onclick="openOnlineWin(1)"/> -->
	...
	<div id="menu_owner_right" class="easyui-menu" style="width: 150px;">
