<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<script type="text/javascript" src="${basePath}js/workhours_statistic.js"></script>
		...
		<div id="toolbar" style="padding: 5px; height: auto;">
			...
			<!-- 	 <td align="right">区域:</td>
		       ...
		       <td align="right">
				...
				<td>
				<!-- <div id="div_starttime">
					<input id="start_time" type="text" class="Wdate" onfocus="WdatePicker()" style="width:160px" /> 
				</div> -->
				<div id="div_starttime2" style="display: block">
					<input id="start_time2" type="text" class="Wdate" onFocus="WdatePicker({ dateFmt: 'yyyy-MM'})" style="width:150px" />
				</div>
				</td>
				<td align="right">
					结束时间: </td>
				<td>
				<!-- <div id="div_endtime">
					<input id="end_time"type="text" class="Wdate" onfocus="WdatePicker()" style="width:160px" /> 
				</div> -->
				<div id="div_endtime2" style="display: block">
					<input id="end_time2"  type="text" class="Wdate" onFocus="WdatePicker({ dateFmt: 'yyyy-MM'})" style="width:150px" />
				</div>
				</td>
			    <td colspan="4">
			   <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search" onclick="statistic_workhours()">查询</a>
