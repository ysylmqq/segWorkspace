...
@Component
@Scope("prototype")
public class CustomerPayPOJO implements Serializable {
    /**
	 * 
	 */
	private static final long serialVersionUID = 1L;

	private BigDecimal custPayId;
    ...
    public BigDecimal getCustPayId() {
        return custPayId;
    }

    public void setCustPayId(BigDecimal custPayId) {
