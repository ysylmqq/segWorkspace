...
import cc.chinagps.gateway.unit.kelong.download.KeLongDownloadCmdEncoder;
import cc.chinagps.gateway.unit.kelong.upload.KeLongUploadCmdHandlers;
...
public class UnitCommon {
	...
	public static KeLongUploadCmdHandlers keLongUploadCmdHandlers = new KeLongUploadCmdHandlers();
	
	public static KeLongDownloadCmdEncoder keLongDownloadCmdEncoder = new KeLongDownloadCmdEncoder();
