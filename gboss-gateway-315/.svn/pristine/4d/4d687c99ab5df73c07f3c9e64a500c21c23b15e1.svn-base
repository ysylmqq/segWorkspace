...
public class CmdUtil {
	...
	public static final int CMD_ID_SET_UPGRADE_PARAM = 0x0316;
	...
	//打开中控锁
	public static final int CMD_ID_LEOPAARD_OPEN_CENTER_CTRL_LOCK = 0x0322;
	
	//关闭中控锁
	public static final int CMD_ID_LEOPAARD_CLOSE_CENTER_CTRL_LOCK = 0x0323;
	...
	public static final int CMD_ID_LEOPAARD_CLOSE_AIRCONDITION = 0x0328;
	
	public static final int CMD_ID_LEOPAARD_SEARCH_VEHICLE = 0x0329;
